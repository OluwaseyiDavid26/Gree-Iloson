...
export default function AboutHero() {
  return (
    <section className="bg-white w-full px-5 sm:px-8 lg:px-14 pt-28 sm:pt-32 lg:pt-36 pb-16">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Left — Text */}
          <div>
          ...
          <div className="relative mt-4 lg:mt-0">
            <div className="rounded-3xl overflow-hidden w-full h-[260px] sm:h-[360px] lg:h-[520px]">
              <img
                src="/about-img.webp"
                alt="Gree Iloson operations"
                className="w-full h-full object-cover"
            ...
            {/* Floating stat card — scales down and pulls in its offset on mobile so it can't bleed past the viewport edge */}
            <div className="absolute -bottom-4 -left-4 sm:-bottom-5 sm:-left-5 bg-white rounded-xl sm:rounded-2xl shadow-xl px-4 py-3 sm:px-6 sm:py-4 flex items-center gap-3 sm:gap-4 border border-gray-100 max-w-[80%] sm:max-w-none">
              <div
              ...
              <div>
                <p className="text-[#1A2B6B] font-bold text-xs sm:text-sm leading-snug">
                  Years of Excellence
                </p>
            ...
            <div
              className="hidden sm:block absolute -top-4 -right-4 w-24 h-24 rounded-2xl -z-10"
              style={{ background: "#C49A3C", opacity: 0.15 }}
            />
          </div>
        </div>
