      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-14">
          ...
          <p className="text-gray-500 text-sm leading-relaxed max-w-xl">
            From a small iron and steel distribution business in Akure to a
            nationwide construction supply and engineering group.
          </p>
        </div>

        {/* 2x2 grid, big year numerals, no connecting line */}
        <div
          className="grid grid-cols-1 md:grid-cols-2 gap-px rounded-2xl overflow-hidden border border-gray-200"
          style={{ background: "#E4E1D8" }}
        >
          {timeline.map((item, i) => (
            <div key={i} className="bg-white p-11">
              <span
                className="block leading-none"
                style={{
                  fontFamily: "var(--font-playfair), serif",
                  fontWeight: 700,
                  fontSize: item.year.length > 4 ? 32 : 56,
                  letterSpacing: item.year.length > 4 ? "0.02em" : "normal",
                  color: item.accent,
                }}
              >
                {item.year}
              ...
              <h3
                className="font-bold text-xl mt-4 mb-2.5"
                style={{
                  color: "#1A2B6B",
                  fontFamily: "var(--font-playfair), serif",
                }}
