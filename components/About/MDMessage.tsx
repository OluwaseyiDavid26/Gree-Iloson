      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative order-2 lg:order-1 mt-6 lg:mt-0">
            <div className="rounded-3xl overflow-hidden w-full h-[280px] sm:h-[400px] lg:h-[560px]">
              <img
                src="/chinedu-ilo.jpeg"
                alt="Chinedu Ilo - Managing Director"
                className="w-full h-full object-cover object-top"
            ...
            {/* Name badge — scales down and pulls its offset in on mobile */}
            <div className="absolute -bottom-4 -right-2 sm:-bottom-5 sm:right-6 bg-[#C49A3C] rounded-xl sm:rounded-2xl px-4 py-3 sm:px-6 sm:py-5 shadow-xl max-w-[70%] sm:max-w-none">
              <p
                className="text-white font-bold text-sm sm:text-base leading-none"
                style={{ fontFamily: "var(--font-playfair), serif" }}
              >
                Chinedu Ilo
              </p>
              <p className="text-white/70 text-[10px] sm:text-xs mt-1 tracking-wide uppercase">
                Managing Director
              </p>
            </div>

            <div className="hidden sm:block absolute -top-4 -left-4 w-24 h-24 rounded-2xl bg-[#1A2B6B]/10 -z-10" />
          </div>
