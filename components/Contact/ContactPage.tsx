                  ...
                  <div className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <textarea
                        ...
                        rows={5}
                        className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-700 placeholder-gray-300 focus:outline-none focus:border-[#1A2B6B] transition-colors duration-200 resize-none"
                      />
                    </div>
                    ...
                    <button
                      ...
                      className="w-full bg-[#1A2B6B] hover:bg-[#152259] text-white font-semibold py-4 rounded-xl text-sm tracking-wide transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#1A2B6B]/20"
                    >
                      Send Message ↗
                    </button>
