...
// Swap these for your own image paths whenever you're ready
const heroImages = [
  "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1800&q=80",
  // "https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=1800&q=80",
  "https://images.unsplash.com/photo-1541976590-713941681591?w=1800&q=80",
];
...
export default function Hero() {
  ...
  // Scroll parallax — background drifts slower than the page scroll
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <section className="bg-white w-full px-3 sm:px-4 pt-3 pb-6">
      ...
      >
        ...
        {/* Crossfading background images with subtle scroll parallax */}
        <div
        ...
        {/* Top right — supporting text + icons, cleared of navbar */}
        <div
          className="absolute top-32 sm:top-36 right-5 sm:right-12 max-w-[200px] sm:max-w-xs text-right"
          style={{
            opacity: mounted ? 1 : 0,
            transform: mounted ? "translateY(0)" : "translateY(-8px)",
            transition: "opacity 0.8s ease 1.1s, transform 0.8s ease 1.1s",
            ...
            {[
              ...
              <div
                ...
                style={{
                  ...
                  opacity: mounted ? 1 : 0,
                  transform: mounted ? "translateY(0)" : "translateY(6px)",
                  transition: `opacity 0.6s ease ${1.3 + i * 0.1}s, transform 0.6s ease ${1.3 + i * 0.1}s`,
                }}
              >
                {icon}
              </div>
        ...
        <div className="absolute bottom-0 left-0 p-8 sm:p-12 max-w-3xl">
          ...
          {/* Headline — line-by-line reveal */}
          <h1
            className="text-white font-bold leading-[1.05] mb-7"
            style={{
              fontSize: "clamp(2.4rem, 5.5vw, 4.5rem)",
              fontFamily: "var(--font-playfair), serif",
            }}
